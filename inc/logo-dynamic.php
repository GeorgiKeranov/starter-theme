...
function starter_theme_the_logo( $placeholder_logo_color = 'white' ) {
	$logo_id = get_theme_mod( 'custom_logo' );

	$logo_details = starter_theme_get_logo_details( $logo_id, $placeholder_logo_color );
...
function starter_theme_get_logo_details($logo_id, $placeholder_logo_color = 'white') {
	$logo_details = array(
